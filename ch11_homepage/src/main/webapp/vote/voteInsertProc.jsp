<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<jsp:useBean id="vDao" class="vote.VoteDao"></jsp:useBean>    
<jsp:useBean id="vList" class="vote.VoteList"></jsp:useBean>
<jsp:setProperty name="vList" property="*" />
<jsp:useBean id="vItem" class="vote.VoteItem"></jsp:useBean>
